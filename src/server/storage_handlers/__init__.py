...
GARAGE_USERNAME = os.environ.get("GARAGE_USERNAME")
GARAGE_PASSWORD = os.environ.get("GARAGE_PASSWORD")
GARAGE_MODEL_BUCKET = os.environ.get("GARAGE_MODEL_BUCKET", "trained-models")
GARAGE_URL = os.environ.get("GARAGE_URL")
